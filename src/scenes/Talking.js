class Talking extends Phaser.Scene {
    ...
    create() {
        ...
        this.First_Witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'First_Witch').setOrigin(0, 1);
        this.Second_Witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Second_Witch').setOrigin(0, 1);
        this.Third_Witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Third_Witch').setOrigin(0, 1);
